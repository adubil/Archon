...
base_url_openrouter = os.getenv('BASE_URL_OPENROUTER', 'https://openrouter.ai/api/v1')
...
router_agent = Agent(  
    OpenAIModel(primary_llm_model, base_url=base_url_openai, api_key=api_key_openai),
